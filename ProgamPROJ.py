                                ...
                                for elem in self.addcarrinho:
                                    ...
                                    if int(elem[4]) == idproduto:
                                        ...
                                        with open('dados_de_compras_usu.csv', mode='a', encoding='utf-8', newline='') as compras:
                                            ...
                                            arq.write(f'O usuário {self.dadosUsu[0]}, com CPF {self.dadosUsu[2]}, realizou uma compra do produto {elem[0]} com uma Qntd.x{elem[3]}, no valor de {str(int(elem[2])*int(elem[3]))}R$  no dia {datahora_da_compra.day}/{datahora_da_compra.month}/{datahora_da_compra.year} às {datahora_da_compra.hour}:{datahora_da_compra.minute}:{datahora_da_compra.second}.\n\n')
                                            arq.close()
                                            for line in armazenador_dados:
                                                escrever.writerow(line)
                                                compras.close()
            ...
            try: 
                ...
                with open('dados_de_compras_usu.csv', mode='a', encoding='utf-8', newline='') as compras:
                    ...
                    for elem in self.addcarrinho: 
                        ...
                        armazenador_dados.append([self.dadosUsu[0],self.dadosUsu[2]]+elem[0:4]+[f'{datahora_da_compra.day}/{datahora_da_compra.month}/{datahora_da_compra.year}', f'{datahora_da_compra.hour}:{datahora_da_compra.minute}:{datahora_da_compra.second}'])
                        arq.write(f'O usuário {self.dadosUsu[0]}, com CPF {self.dadosUsu[2]}, realizou uma compra do produto {elem[0]} em uma Qntd.x{elem[3]}, no valor de {str(int(elem[2])*int(elem[3]))}R$  no dia {datahora_da_compra.day}/{datahora_da_compra.month}/{datahora_da_compra.year} às {datahora_da_compra.hour}:{datahora_da_compra.minute}:{datahora_da_compra.second}.\n\n')
